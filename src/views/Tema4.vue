  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5(data-aos="fade")
    .titulo-principal.color-acento-contenido
      .titulo-principal__numero
        span.colspan 4
      h1 Sistema de administración de riesgos                                              
    .row
      .col-lg-5
        img(data-aos="fade-right")(src='@/assets/curso/tema4/img1.png', alt='Texto que describa la imagen')
    ...
    #t_4_1.titulo-segundo.color-acento-contenido
      h2 4.1  Contextualización general     
    .row.bg2      
      p Los beneficios de la administración de riesgos pueden no ser tan visibles o evidentes frente a la ejecutividad que provenga de la gestión. Este argumento puede deberse a que se identifica el riesgo específicamente con amenazas o contingencias negativas. Sin embargo, el riesgo es difícil de eliminar de la actividad empresarial, por naturaleza estará ahí, siempre va a existir.
      .row
        .col-lg-4
      ...
      p.mt-5 Estos beneficios de la administración de riesgos impactan de manera directa en cuanto al crecimiento, la visibilidad, prestigio, el buen nombre y resultados de la empresa.
      separador
      #t_4_2.titulo-segundo.color-acento-contenido
        h2 4.2  Alertas y operaciones
      p La administración de riesgos tiene como principal función la identificación de los inconvenientes o eventos que pueden ocurrir en el desarrollo de una actividad determinada, la identificación de riesgos es un proceso que permite detectar oportunamente posibles acontecimientos y amenazas que afecten directamente las finanzas, recurso humano y patrimonio de la organización.
      .row
        .col-lg-5.mt-5
